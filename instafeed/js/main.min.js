...
function check_if_next(){
	if(feed.hasNext()){
		feed.next();
		$('body').append('Still parsing images from Instagram<br>');
	}else{
		$('body').append('I\'m done dude!<br>');
		$('body').append(number_image + ' image(s) added to the Database');
	}
}


function post_image(id_photo, url, img, caption, user, user_photo, date_photo){
